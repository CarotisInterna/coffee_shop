...
public class CartController {
     ...
     */
    @PutMapping("/place")
    public ResponseEntity<OrderDto> placeOrder(@RequestBody @Validated(PlaceOrderGroup.class) OrderDto orderDto,
                                               BindingResult result) {
     ...
     */
    @PutMapping("/reject")
    public ResponseEntity<OrderDto> rejectOrder(@RequestBody OrderDto orderDto) {

        OrderDto placedOrderDto = cartService.rejectOrder(orderDto);
        return ResponseEntity.ok(placedOrderDto);
     ...
     */
    @PutMapping("/deliver")
    public ResponseEntity<OrderDto> deliverOrder(@RequestBody OrderDto orderDto) {

        OrderDto placedOrderDto = cartService.deliverOrder(orderDto);
        return ResponseEntity.ok(placedOrderDto);
